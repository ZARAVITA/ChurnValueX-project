...
def build_welcome(t):
    block = (
        ...
        "  -webkit-text-fill-color:#38B2AC !important;"
        "}"
        ".wcSub{"
        ...
        "}"
        ".wcStats{display:flex;flex-direction:column;gap:.7rem;min-width:160px;}"
        ".wcStatPill{"
        "  border-radius:13px;"
        ...
        "}"
        ".wcStatPill:hover{ transform:translateY(-2px); }"
        ".wcStatPill-cyan{"
        "  background:linear-gradient(135deg,#0F2E4F 0%,#123B52 100%);"
        "  border:1px solid #1D9BF0;"
        "  box-shadow:0 0 18px rgba(29,155,240,0.22),0 2px 12px rgba(0,0,0,0.35);"
        "}"
        ".wcStatPill-teal{"
        "  background:linear-gradient(135deg,#0D2E38 0%,#0F3A40 100%);"
        "  border:1px solid #14B8A6;"
        "  box-shadow:0 0 18px rgba(20,184,166,0.2),0 2px 12px rgba(0,0,0,0.35);"
        "}"
        ".wcStatPill-electric{"
        "  background:linear-gradient(135deg,#0D1F4E 0%,#112358 100%);"
        "  border:1px solid #3B82F6;"
        "  box-shadow:0 0 18px rgba(59,130,246,0.22),0 2px 12px rgba(0,0,0,0.35);"
        "}"
        ".wcStatVal{"
        "  font-size:1.55rem;font-weight:800;"
        "  letter-spacing:-.03em;line-height:1;"
        "}"
        ".wcStatVal-cyan     { color:#4FD1C5 !important; }"
        ".wcStatVal-teal     { color:#2DD4BF !important; }"
        ".wcStatVal-electric { color:#60A5FA !important; }"
        ".wcStatLbl{"
        "  font-size:12px;"
        ...
        "<div>"
        "<div class='wcTitle'>Bienvenue sur&nbsp;"
        "<span class='wcChurnRed'>Churn</span>"
        "<span class='wcIQGreen'>IQ</span>"
        "</div>"
        "<div class='wcSub'>Systeme décisionnel intelligent conçu pour anticiper le churn, protéger votre revenu et maximiser la valeur client.</div>"
        "<div class='wcDesc'>Transformez vos données CRM en décisions business actionnables &mdash; identifiez les clients à risque et estimez le revenu exposé en temps réel.</div>"
        "</div>"

        "<div class='wcStats'>"
        "<div class='wcStatPill wcStatPill-cyan'>"
        "  <div class='wcStatVal wcStatVal-cyan'>98%</div>"
        "  <div class='wcStatLbl'>Precision</div>"
        "</div>"
        "<div class='wcStatPill wcStatPill-teal'>"
        "  <div class='wcStatVal wcStatVal-teal'>5</div>"
        "  <div class='wcStatLbl'>Dashboards</div>"
        "</div>"
        "<div class='wcStatPill wcStatPill-electric'>"
        "  <div class='wcStatVal wcStatVal-electric'>12M</div>"
        "  <div class='wcStatLbl'>CLV horizon</div>"
        "</div>"
        "</div>"
        ...
        "<div class='wcCols'>"
        "<div class='wcCard'>"
        "<div class='wcSecLbl'>Capacités intelligentes</div>"
        "<div class='wcCapList'>"
        "<div class='wcCapItem'><div class='wcChk'>&#10003;</div>Vision client 360&deg;</div>"
        "<div class='wcCapItem'><div class='wcChk'>&#10003;</div>Détection prédictive du churn</div>"
        "<div class='wcCapItem'><div class='wcChk'>&#10003;</div>Analyse CLV &amp; revenu à risque</div>"
        "<div class='wcCapItem'><div class='wcChk'>&#10003;</div>Segmentation intelligente orientée décision</div>"
        ...
        "<div class='wcInfoTxt'><strong>Adaptable</strong> aux données, KPIs et objectifs spécifiques de chaque entreprise.</div>"
        "</div>"
        "<hr class='wcHr'>"
        "<div class='wcInfoRow'>"
        "<div class='wcInfoIco'>&#128196;</div>"
        "<div class='wcInfoTxt'><strong>Dataset de demo</strong> intégré &mdash; ou synthétique (900 clients) si le fichier est absent.</div>"
        "</div>"
        "<hr class='wcHr'>"
        "<div class='wcInfoRow'>"
        "<div class='wcInfoIco'>&#9654;</div>"
        "<div class='wcInfoTxt'>Cliquez sur <strong>&#34;Lancer une simulation business&#34;</strong> dans le panneau gauche pour activer le système.</div>"
        "</div>"
        "</div>"
        "</div>"
        "<div class='wcExpWrap'>"
        ...
        "<div>"
        "<div class='wcExpLabel'>Intelligence analytique multi-modèles</div>"
        "<div class='wcExpSub'>Cliquez pour découvrir l&rsquo;architecture IA</div>"
        "</div>"
        "</div>"
        ...
        "<ul class='wcList'>"
        "<li><div class='wcListDot'></div>Intelligence prédictive</li>"
        "<li><div class='wcListDot'></div>Analyse comportementale</li>"
        "<li><div class='wcListDot'></div>Modélisation CLV</li>"
        "<li><div class='wcListDot'></div>Analyse de survie</li>"
        "</ul>"
        "<p class='wcNote'>dans une interface exploitable par les équipes métier et décisionnelles.</p>"
        "</div>"
        "</div>"
        "</div>"
    )
...
st.markdown(
    ...
    'D&eacute;velopp&eacute; par <strong>ZARA VITA</strong> &mdash; Smart Automation Technologies &middot; '
